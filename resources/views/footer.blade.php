<footer class="text-gray-600 bg-white body-font dark:bg-gray-700">
    <div class="container flex flex-col items-center px-5 py-8 mx-auto sm:flex-row">
        <a
            ...
            <x-jet-application-mark class="block w-auto h-10 text-white fill-current" />
            <span class="ml-3 text-xl">Rhys Lees</span>
        </a>
        <p
            class="mt-4 text-sm text-gray-500 dark:text-gray-300 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0">
            ©
            {{ now()->format('Y') }} Rhys Lees
